...
function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-[env(safe-area-inset-bottom)] left-0 w-full h-20 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg z-50">
      <div className="h-full">
        <div className="flex justify-around items-center h-full px-4">
          <Link 
            to="/" 
            className={`flex flex-col items-center space-y-2 min-w-[4rem] ${
